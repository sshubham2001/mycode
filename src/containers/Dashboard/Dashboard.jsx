      ...
      <Row>
        <Col lg={3} sm={6} xs={12} className={mb30}>
          <StickerCard
            ...
            icon={<CoinIcon />}
            price={`₹ ${
              adminReport?.totalRevenue?.toFixed(2) === undefined
                ? "Loading..."
                : adminReport?.totalRevenue?.toFixed(2)
            }`}
            indicator="up"
        ...
        <Col lg={3} sm={6} xs={12} className={mb30}>
          <StickerCard
            ...
            icon={<CartIconBig />}
            price={`${
              adminReport?.totalOrders === undefined
                ? "Loading..."
                : adminReport?.totalOrders
            }`}
            indicator="up"
        ...
        <Col lg={3} sm={6} xs={12}>
          <StickerCard
            ...
            icon={<UserIcon />}
            price={`${
              adminReport?.totalCustomers === undefined
                ? "Loading..."
                : adminReport?.totalCustomers
            }`}
            indicator="up"
        ...
        <Col lg={3} sm={6} xs={12}>
          <StickerCard
            ...
            icon={<DeliveryIcon />}
            price={`${
              adminReport?.totalDelivered === undefined
                ? "Loading..."
                : adminReport?.totalDelivered
            }`}
            indicator="up"
      ...
      <Row>
        ...
        <Col md={5} lg={4}>
          <DonutChart
            widgetTitle="Target"
            series={[
              adminReport?.totalFullRevenue === undefined
                ? "Loading..."
                : adminReport?.totalFullRevenue,
              adminReport?.totalRevenue === undefined
                ? "Loading..."
                : adminReport?.totalRevenue,
            ]}
            labels={["Total Order Revenue", "Total Delivered Revenue"]}
            colors={["#03D3B5", "#666d92"]}
            helperText={["Weekly Targets", "Monthly Targets"]}
            icon={[<Revenue />, <Refund />]}
            prefix="₹"
